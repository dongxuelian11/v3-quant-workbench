...
export function StrategyPanel({ run = false }: { run?: boolean }) {
  ...
  const [benchmark, setBenchmark] = useState(String(saved.benchmark ?? (JSON.stringify(s.project!.universe).includes("csi500") ? "csi500" : "csi300")));
