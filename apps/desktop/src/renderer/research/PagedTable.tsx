...
export function PagedExperimentTable({ experimentId, table, onRow, initialSymbol = "" }: { experimentId: string; table: string; initialSymbol?: string; onRow?: (row: JsonObject) => void }) {
  const s = useResearch();
