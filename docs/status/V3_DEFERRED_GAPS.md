...
| `V1-1-UI-POLISH-06` | `DEFERRED` | V1.0 forward scan | Additional visual polish, accessibility expansion, and advanced empty/degraded presentation are not required to prove the current normal path. | Current basic product usability remains the V1 gate; broader visual acceptance is not promoted. | V1.1 exact-head visual/accessibility review. |
